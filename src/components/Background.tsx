    ...
    <section className="section" id="background">
      <div className="container">
        ...
        <p className="philosophy-line">
          I don&apos;t believe businesses need more digital noise — they need clarity in
          what they offer, who it&apos;s for, and why someone should care.
        </p>
        <p className="background-intro">
          That&apos;s where design becomes valuable: turning that clarity into something
          people can see, understand, and act on. Before websites and social media, I spent
          over a decade in Sales Operations, Business Development, SaaS, and Key Account
          Management — learning first-hand what makes a customer say yes. That&apos;s the
          lens behind every site, page, and product I build today.
        </p>
